ViewSettings = {
	...
	[1] = {-- player slot 1 --Current view is a bit fucked its too level with the frame might have to unfuck the external...
		CockpitLocalPoint = {6.35,1.0,0.1},--{7.105000,1.350000,0.000000}/////--{6.957000,1.322000,0.000000} with dummy at 0,0,0
		...
		EyePoint               = {0.0,-1.000000 ,0.000000},
		limits_6DOF            = {x = {-0.15,0.28},y = {-0.35,.1},z = {-0.22,.22},roll = 90.000000},
		ShoulderSize		   = 0.15,-- bewegt K�rper, wenn Azimuth Wert mehr als 90 Grad
