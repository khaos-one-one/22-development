...
BGROUND.element_params 		= {"MFD_OPACITY","LMFD_IRST_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
MENU_CHK_TEXT.element_params 	    = {"MFD_OPACITY","LMFD_IRST_PAGE"}
...
CENTER_TEXT.value 				    = "CENTER IRST PLACEHOLDER"
...
CENTER_TEXT.element_params 	        = {"MFD_OPACITY","LMFD_IRST_PAGE","BAY_STATION"}
...
LEFT_TEXT.element_params 	        = {"MFD_OPACITY","LMFD_IRST_PAGE","BAY_STATION"}
...
RIGHT_TEXT.element_params 	        = {"MFD_OPACITY","LMFD_IRST_PAGE","BAY_STATION"}
