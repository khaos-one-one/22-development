...
BGROUND.element_params 		= {"MFD_OPACITY","LMFD_BLANK_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
LOGO.init_rot 			= {0, 0, 0}
LOGO.element_params 		= {"MFD_OPACITY","LMFD_BLANK_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
