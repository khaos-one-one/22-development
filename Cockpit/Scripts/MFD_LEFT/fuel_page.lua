...
BGROUND.element_params 		= {"MFD_OPACITY","LMFD_FUEL_PAGE"}
...
FUELQTY.element_params 		= {"MFD_OPACITY","LMFD_FUEL_PAGE","FUEL"}
FUELQTY.controllers			= {
...
FUELQTY2.element_params 		= {"MFD_OPACITY","LMFD_FUEL_PAGE","FUEL"}
...
FUELQTY_TANK.element_params 	    = {"MFD_OPACITY","LMFD_FUEL_PAGE","FUELT"}
...
FUEL_BLK.element_params 	= {"LMFD_FUEL_PAGE","MAIN_POWER"}
...
FUELFRAME.element_params 		= {"MFD_OPACITY","LMFD_FUEL_PAGE"}
...
FUELFRAME_JETT.element_params 		= {"MFD_OPACITY","LMFD_FUEL_PAGE"}
...
FUEL_BX.element_params 		= {"LMFD_FUEL_PAGE","MAIN_POWER"}
...
TANK_LABELS.element_params 	= {"MFD_OPACITY","LMFD_FUEL_PAGE"}
...
BINGO_txt.element_params 	= {"MFD_OPACITY","BINGO_LIGHT","LMFD_FUEL_PAGE"}
...
BINGO_TEXT.element_params 	        = {"MFD_OPACITY","LMFD_FUEL_PAGE"}
...
BINGOQTY_TEXT.element_params 	    	= {"MFD_OPACITY","LMFD_FUEL_PAGE"}
...
FUELDUMP_TEXT.element_params 	    = {"MFD_OPACITY","LMFD_FUEL_PAGE"}
...
ACTIVE_TEXT.element_params 	        = {"MFD_OPACITY","DUMP_FUEL","LMFD_FUEL_PAGE"}
...
MENUTEXT.element_params 	        = {"MFD_OPACITY","LMFD_FUEL_PAGE"}
...
JETTISON_YEL.element_params 	        = {"MFD_OPACITY","LMFD_FUEL_PAGE"}
...
JETTISON_YEL1.element_params 	        = {"MFD_OPACITY","LMFD_FUEL_PAGE"}
