...
NAVTEXT.element_params 	        = {"MFD_OPACITY","CMFD_MENU_PAGE"}
NAVTEXT.controllers		        =   {
...
RWRTEXT.element_params 	        = {"MFD_OPACITY","CMFD_MENU_PAGE"}
RWRTEXT.controllers		        =   {
                                            {"opacity_using_parameter",0},
                                            {"parameter_in_range",1,0.9,1.1},--MENU PAGE = 0
						                }
...
CLOCK.level				= 2
CLOCK.element_params	= {"MFD_OPACITY","CLOCK","CMFD_MENU_PAGE"}
