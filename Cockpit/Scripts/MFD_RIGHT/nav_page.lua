...
BGROUND.element_params 		= {"MFD_OPACITY","RMFD_NAV_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
ICON.init_rot 			= {0, 0, 0}
ICON.element_params 		= {"MFD_OPACITY","RMFD_NAV_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
CIRCLE1.element_params 		= {"MFD_OPACITY","RMFD_NAV_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
COMPASS_ROSE_NUM.element_params 		= {"MFD_OPACITY","RMFD_NAV_PAGE","TRUE_HEADING"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
HEAD_BOX.element_params 		= {"MFD_OPACITY","RMFD_NAV_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
HEAD_BOX_LINE.element_params 		= {"MFD_OPACITY","RMFD_NAV_PAGE"}--this may not be bneeded check when more pages done for backlight on page 7 SMS fc3 bs
...
HEAD_VAL.level				= 11
HEAD_VAL.element_params	= {"MFD_OPACITY","TRUE_HEADING","RMFD_NAV_PAGE"}
...
CLOCK.level				= 11
CLOCK.element_params	= {"MFD_OPACITY","CLOCK","RMFD_NAV_PAGE"}
...
DATE.level				= 11
DATE.element_params	= {"MFD_OPACITY","DATE","RMFD_NAV_PAGE"}
...
LATITUDE.level				= 11
LATITUDE.element_params	= {"MFD_OPACITY","LATITUDE","RMFD_NAV_PAGE"}
...
LONGITUDE.level				= 11
LONGITUDE.element_params	= {"MFD_OPACITY","LONGITUDE","RMFD_NAV_PAGE"}
...
MENUTEXT.element_params 	        = {"MFD_OPACITY","RMFD_NAV_PAGE"}
