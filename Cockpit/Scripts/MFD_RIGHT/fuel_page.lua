...
BGROUND.element_params 		= {"MFD_OPACITY","RMFD_FUEL_PAGE"}
...
FUELQTY.element_params 		= {"MFD_OPACITY","RMFD_FUEL_PAGE","FUEL"}
FUELQTY.controllers			= {
...
FUELQTY2.element_params 		= {"MFD_OPACITY","RMFD_FUEL_PAGE","FUEL"}
...
FUELQTY_TANK.element_params 	    = {"MFD_OPACITY","RMFD_FUEL_PAGE","FUELT"}
...
FUEL_BLK.element_params 	= {"RMFD_FUEL_PAGE","MAIN_POWER"}
...
FUELFRAME.element_params 		= {"MFD_OPACITY","RMFD_FUEL_PAGE"}
...
FUELFRAME_JETT.element_params 		= {"MFD_OPACITY","RMFD_FUEL_PAGE"}
...
FUEL_BX.element_params 		= {"RMFD_FUEL_PAGE","MAIN_POWER"}
...
TANK_LABELS.element_params 	= {"MFD_OPACITY","RMFD_FUEL_PAGE"}
...
BINGO_txt.element_params 	= {"MFD_OPACITY","BINGO_LIGHT","RMFD_FUEL_PAGE"}
...
BINGO_TEXT.element_params 	        = {"MFD_OPACITY","RMFD_FUEL_PAGE"}
...
BINGOQTY_TEXT.element_params 	    	= {"MFD_OPACITY","RMFD_FUEL_PAGE"}
...
BINGOQTY_TEXT.name				= "BINGOQTY_TEXT"
BINGOQTY_TEXT.material			= UFD_FONT
BINGOQTY_TEXT.init_pos			= {0.95, 0.45, 0} 
BINGOQTY_TEXT.alignment			= "RightCenter"
BINGOQTY_TEXT.stringdefs			= {0.0045, 0.0045, 0, 0.0} 
BINGOQTY_TEXT.additive_alpha		= true
BINGOQTY_TEXT.collimated			= false
BINGOQTY_TEXT.isdraw				= true	
BINGOQTY_TEXT.use_mipfilter		= true
BINGOQTY_TEXT.h_clip_relation		= h_clip_relations.COMPARE
BINGOQTY_TEXT.level				= 2
BINGOQTY_TEXT.element_params		= {"MFD_OPACITY","BINGO_VAL","RMFD_FUEL_PAGE"}
BINGOQTY_TEXT.formats				= {"%04.0f"}
BINGOQTY_TEXT.controllers			= {{"opacity_using_parameter",0},{"text_using_parameter",1,0},{"parameter_in_range",2,0.9,1.1}}
Add(BINGOQTY_TEXT)
...
FUELDUMP_TEXT.element_params 	    = {"MFD_OPACITY","RMFD_FUEL_PAGE"}
...
ACTIVE_TEXT.element_params 	        = {"MFD_OPACITY","DUMP_FUEL","RMFD_FUEL_PAGE"}
...
MENUTEXT.element_params 	        = {"MFD_OPACITY","RMFD_FUEL_PAGE"}
...
JETTISON_YEL.element_params 	        = {"MFD_OPACITY","RMFD_FUEL_PAGE"}
...
JETTISON_YEL1.element_params 	        = {"MFD_OPACITY","RMFD_FUEL_PAGE"}
