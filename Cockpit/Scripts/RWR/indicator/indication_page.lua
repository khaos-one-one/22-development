...
local x_size = 0.004
local y_size = 0.9 * RS * 20
local radius = 0.1 * RS * 20
local	wmul = 0.88 
...
Add(mfd_base_rwr)	
	...
	local   RWR_grid_i 					= CreateElement "ceMeshPoly"
			...
			set_circle	(RWR_grid_i, radius + 0.0060, radius - 0.0060, 360, 32)
			RWR_grid_i.material 		= MFCD_GREEN
		...
		Add(RWR_grid_i)
----------------------------- CIRCLE BACKGROUND RWR BASE FIRST-----------------------------	
	radius = 0.7 * RS * 20
	local   RWR_grid_o 					= CreateElement "ceMeshPoly"
			RWR_grid_o.name 			= "RWR_grid_o"
			RWR_grid_o.primitivetype 	= "triangles"
			set_circle	(RWR_grid_o, radius + 0.0060, radius - 0.0060, 360, 48)
			RWR_grid_o.material 		= MFCD_BLUE
		...
		Add(RWR_grid_o)	
----------------------------- CIRCLE BACKGROUND RWR BASE SECOND-----------------------------
	radius = 0.25 * RS * 20
	local   RWR_grid_m 					= CreateElement "ceMeshPoly"
			RWR_grid_m.name 			= "RWR_grid_m"
			RWR_grid_m.primitivetype 	= "triangles"
			set_circle	(RWR_grid_m, radius + 0.0060, radius - 0.0060, 360, 32)
			RWR_grid_m.material 		= MFCD_BLUE
