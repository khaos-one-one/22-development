...
--MISSILES
  ...
  --['AIM_120C_5']	 		= 'Mu',
    ...
    ['RVV-SBD']	 		    = 'MR',
	['Astra']	 			= 'MI',
	['I-Derby ER BVRAAM Active Rdr AAM'] = 'ME',
	['Meteor BVRAAM Active Rdr AAM'] = 'MF',
	['MBDA_Meteor']	 		= 'MF',
	['METEOR']	 			= 'MF',
	['EF_Meteor']	 		= 'MF',
	['MICA_NG']	 			= 'MF',
...
------------------------------------------------------------------	
	['Meteor-N'] 			= 'MF',		
	['Meteor BVRAAM (NUCLEAR) - Active Rdr AAM'] 			= 'MF',	
	['AIM-120B AMRAAM Active Rdr AAM'] 						= 'Mu',	
	['AIM-120C-5 AMRAAM Active Rdr AAM'] 					= 'Mu',	
	['AIM-120C-7 AMRAAM Active Rdr AAM'] 					= 'Mu',		
-------------------------------------------------------------------
...
function get_threat_type(tmp_rwr_type, name_type)
	vtmp_rwr_type = symbols_strings[tmp_rwr_type]
