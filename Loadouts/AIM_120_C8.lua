...
local AIM_120_C8 =
{
	...
	ModelData = {58,    --MODEL PARAMETERS COUNT
				...
				0.0,		0.0,	6.15,		0.0,		0.0,			0.0,		0.0,        -- fuel flow rate in second
				0.0,		0.0,	15311,	    0.0,		0.0,			0.0,		0.0,        -- thrust, newtons
				
				1.0e9,
				140.0,       -- LIFETIME BATTERY	(SEC)	
				0, 
				1.0, 
				...
				-25.0,
				-3.0, 
				64000.0,     -- TARGET DIRECTLY TOWARDS THE CARRIER AT 5000FT, (900KM/H)(486kts)
				32000.0,     -- TARGET DIRECTLY AWAY FROM THE CARRIER AT 5000FT, (900KM/H)(486kts)
				109000.0,    -- TARGET DIRECTLY TOWARDS THE CARRIER AT 10000FT, (900KM/H)(486kts)
				54500.0,     -- TARGET DIRECTLY AWAY FROM THE CARRIER AT 10000FT, (900KM/H)(486kts)
				44000.0,     -- TARGET DIRECTLY TOWARDS THE CARRIER AT 1000FT, (900KM/H)(486kts)
				22000.0,     -- TARGET DIRECTLY AWAY FROM THE CARRIER AT 1000FT, (900KM/H)(486kts)
				4000.0,
				0.4,
				-0.015,
				0.5,
