...
local UFDL_OSB2		  = 10155
local UFDL_OSB3		  = 10156
local UFDL_OSB4		  = 10157
local UFDR_OSB2		  = 10158
local UFDR_OSB3		  = 10159
local UFDR_OSB4		  = 10160

local Cannon_Select	  	= 10161
local Fox2_Select		= 10162
local Fox2_Select		= 10163
local Deploy_Flare		= 10164
local Deploy_Chaff		= 10165
local Jammer_Toggle 	= 10166
...
--F-22 Weapons
	...
	{down = Cannon_Select, up = Cannon_Select, name = _('Weapons: Select Cannon'),		category = _('F-22A HOTAS')},

--F-22 ECMS
	{down = Deploy_Chaff, up = Deploy_Chaff, name = _('ECMS: Dispense Chaff'),			category = _('F-22A HOTAS')},
	{down = Deploy_Flare, up = Deploy_Flare, name = _('ECMS: Dispense Flare'),			category = _('F-22A HOTAS')},
	{down = Jammer_Toggle,					 name = _('ECMS: Jammer Toggle'),			category = _('F-22A HOTAS')},
